  ...
  <div class="container">
    <div class="row">
        ...
        ?>
            ...
            <div class="product-listing-m gray-bg">
              ...
              <div class="product-listing-content">
                ...
                <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id); ?>" class="btn" style="background-color:blue;">Деталі </a>
              </div>
            </div>
        <?php }
        } ?>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget" style="background-color:forestgreen;">
          <div class="widget_heading">
            <h5 style="color:yellow;"> Фільтр </h5>
          </div>
